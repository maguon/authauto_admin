...
function addProcureOffer(params,callback){
    var query = " insert into procure_offer (procure_id,supplier_id,user_id,price,qty) " +
        " values ( ? , ? , ? , ? , ? )";
    var paramsArray=[],i=0;
...
function getOfferFullInfo(params,callback){
    var query ="select pi.auto_id,pi.name_en,pi.name_cn,pi.img,pi.remark,pi.end, " +
        ...
        " po.id,po.supplier_id,po.user_id,po.price,po.qty,po.created_on,po.updated_on, " +
